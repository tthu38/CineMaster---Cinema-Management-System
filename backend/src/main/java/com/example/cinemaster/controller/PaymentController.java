...
//
//                    // 🧩 Kiểm tra trạng thái vé để quyết định có gửi mail hay không
//                    Ticket ticket = ticketRepository.findById(ticketId)
//                            .orElseThrow(() -> new RuntimeException("Không tìm thấy vé sau khi ghi Payment!"));
//
//                    if (ticket.getTicketStatus() == Ticket.TicketStatus.HOLDING) {
//                        // 🟢 Chỉ gửi mail nếu vé vẫn đang giữ chỗ
//                        ticketService.confirmPayment(ticketId);
//                        log.info("📩 Đã xác nhận & gửi mail vé {}", ticketId);
//                    } else {
//                        log.info("📨 Vé {} đã BOOKED rồi, bỏ qua gửi mail để tránh lỗi 500.", ticketId);
//                    }
//                }
//
...
//
//}
// ============ FILE 2: TicketService.java (Method confirmPayment) ============
                ...
                if (ticketId != null) {
                    ...
                    if (ticket.getTicketStatus() == Ticket.TicketStatus.HOLDING) {
                        ...
                        try {
                            ...
                            // ⚠️ Nếu gửi mail lỗi, vẫn trả về success nhưng log lỗi
